...
public class EtsyItem2 {
    public static void main(String[] args){
     String title= "Soup Cook Off Personalized Wooden Spoon";
     String seller= "Personalized Gallery";
     Double stars= 5.0;
     int ratingsCount=8901;
     double price= 8.00;
     boolean bestSellers= true;
     boolean freeShipping= true;

     // Seller name is <PersonalizedGallery> = //System.out.println("Seller name is <" + seller + ">")
     ...
     // Best seller is true
        System.out.println("Best seller is " + bestSellers);
