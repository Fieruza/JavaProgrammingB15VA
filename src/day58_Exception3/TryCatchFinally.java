...
public class TryCatchFinally {
    public static void main(String[] args) {
        try {
            ...
            URL etsyURL = new URL("www.etsy.com");//checked exception, we have two options using declare or try catch handle.
        ...
        try {
            ...
            int num = Integer.parseInt("123abc");//Converting string to int, unchecked exception
