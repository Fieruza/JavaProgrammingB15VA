...
public class StringReplace {
    public static void main(String[] args) {
        ...
        words = words.replace("pyhton", "java");
        ...
        capital= capital.replace("London","Asmara");
        capital= capital.replace("UK","Eritrea");
        System.out.println("capital =" + capital);

        capital= capital.replace("London","Asmara").replace("UK","Eritrea");
