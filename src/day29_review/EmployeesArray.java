...
public class EmployeesArray {
    public static void main(String[] args) {
        ...
        for (String workers :employees) {
            String job = workers.substring(workers.indexOf("[")+1,workers.indexOf("]"));
        ...
        for (String title: employees) {
            ...
            String first = titleArr[0];
            String last = titleArr[1];
            //String job = title.substring();

        }
    }
}
//TODO : Add condition to check Mr.Skipper data

//TODO Task 4
//print initials --> job title for everyone
